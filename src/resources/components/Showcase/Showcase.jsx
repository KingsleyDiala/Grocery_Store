    ...
    <Showcase >
      <ShowcaseContainer>
        ...
        <Content
          ...
          viewport={{ once: true }}
          transition={{ delay: .5, duration: 1.5, type: "spring", bounce: 1 }}
        >
        ...
        <Content
          ...
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ delay: .6, duration: 1.5, type: "spring", bounce: 1 }}
        >
        ...
        <Content
          ...
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ delay: .7, duration: 1.5, type: "spring", bounce: 1 }}
        >
